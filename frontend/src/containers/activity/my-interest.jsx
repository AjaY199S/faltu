...
export default class MyInterest extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      record: [],
  ...
  getUserInterests = async () => {
    ...
    await UserService.getInterest(filter)
      .then((response) => {
        let responseData = response.data;
        if (responseData.success) {
          this.setState({
          ...
          responseData.data.map((data) => {
            ...
            let time =
              (new Date().getTime() - new Date(data.updatedOn).getTime()) /
              1000;
            let newTime = seconds_to_days_hours_mins_secs_str(time);
            data.updatedOn = newTime;
          });
              ...
              <div className="modal-body">
                ...
                {/* <div class="text-center">
                  <ul class="listing-image">
                    <li>
                      <a href="#">
                        <img src="https://cdn.muslima.com/memphoto/Photo2/small/17150694.jpg" />
                      </a>
                    </li>
                    <li>
                      <a href="#">
