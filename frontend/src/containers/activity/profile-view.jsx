...
export default class ProfileView extends React.Component {
  ...
  getProfile = async () => {
    ...
    await UserService.getviewedPrfoile(filter)
      .then((response) => {
        let responseData = response.data;
        if (responseData.success) {
          this.setState({
                        ...
                        <div className="featured-box card-box p-3 mb-0">
                              ...
                              <div className="text">
                                <ul className="pl-0 mb-0">
                                  ...
                                  <li className="common mb-2 msg">
                                    Received :{" "}
                                    {users.updatedOn ? users.updatedOn : ""}
                                  </li>
                                </ul>
                              </div>
                            </div>
                          ...
                          <div className="d-flex">
                            <div className="icon">
                              ...
                              {favoriteUserId.indexOf(users._id) != -1 ? (
                                <span
                                  className="mr-1 trashes"
                                  title="Remove Favorite"
                                  onClick={(event) =>
                                    this.removeFavorite(users._id)
                                  }
                                >
