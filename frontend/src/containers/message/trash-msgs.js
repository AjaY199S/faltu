...
import { ERRORMSG, SERVERURL, PERPAGE, DIFFYRS } from "../../globals/constant";
import ReactPaginate from "react-paginate";
import base from "../../globals/base";
const IMG = base + "assets/images/customer.png";

export default class TrashMsgs extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      perPage: PERPAGE,
  ...
  getDeletedMsgs = async () => {
    try {
      let messages = firebase.ref("chats/");
      messages
        .orderByValue()
        .equalTo("5e7db1792259230210928e94")
        // .limitToLast(10)
        .on("value", async (snapShot) => {
          console.log(snapShot, "asd");
          snapShot.forEach((child) => {
            console.log(child, "sadsad");
